...
<body class="bg-gray-100">
    <header class="p-5 border-b bg-white shadow">
        <div class="container mx-auto flex justify-between items-center">
            ...
            @auth
                <nav class="font-bold uppercase text-gray-600 text-sm flex gap-2 items-center">
                    <a 
                        href="{{ route('posts.create') }}"
                        class="inline-flex items-center gap-2 border p-2 text-gray-600 rounded text-sm uppercase font-bold cursor-pointer">
            ...
            <nav class="font-bold uppercase text-gray-600 text-sm">
